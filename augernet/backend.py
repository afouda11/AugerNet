...
def _handle_feature_override(data, cfg, overrides):
    ...
    Returns the resolved feature tag string.
    """
...
def load_data(cfg) -> Dict[str, Any]:
    ...
    Auger-GNN fitted: singlet + triplet stick data → y_fitted built on-the-fly.
...
def run_predict(*, model_path: str, predict_dir: str, fold, cfg):
    ...
    norm_stats = torch.load(cfg.norm_stats_file)

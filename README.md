...
A Future release of this code will include GNN predictions of Auger-electron spectroscopy (AES) and CNN classifications of local bond envrionments from AES spectra augmented with CEBEs.
